...
public final class Class3 {
	...
	public void method55(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("27215, " + arg0 + ", " + local25.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!bc", name = "a", descriptor = "(II)I")
	public int method56(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			if (arg1 >= 0) {
				return 3;
			}
			...
			signlink.reporterror("89140, " + arg0 + ", " + arg1 + ", " + local94.toString());
			throw new RuntimeException();
		}
	}
}
