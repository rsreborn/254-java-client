...
public final class Class1_Sub1_Sub2_Sub4 extends Class1_Sub1_Sub2 {
	...
	public void method465(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		try {
			if (arg2 == 0) {
				this.method468(arg4, arg3 - this.method467(arg1, true) / 2, arg0, this.anInt750, arg1);
			}
		} catch (@Pc(19) RuntimeException local19) {
			signlink.reporterror("31550, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + local19.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!lb", name = "a", descriptor = "(IILjava/lang/String;ZIZ)V")
	public void method466(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		try {
			if (!arg3) {
				this.aBoolean187 = !this.aBoolean187;
			}
			this.method470(arg5, arg2, arg4, (byte) 45, arg0, arg1 - this.method467(arg2, true) / 2);
		} catch (@Pc(26) RuntimeException local26) {
			signlink.reporterror("2313, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + arg5 + ", " + local26.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!lb", name = "a", descriptor = "(Ljava/lang/String;Z)I")
	public int method467(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) {
		try {
			if (arg0 == null) {
				return 0;
			}
			...
			if (arg1) {
				...
				return this.anInt749;
			}
		} catch (@Pc(54) RuntimeException local54) {
			signlink.reporterror("54751, " + arg0 + ", " + arg1 + ", " + local54.toString());
			throw new RuntimeException();
		}
	}
	...
	public void method469(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2, @OriginalArg(3) int arg3, @OriginalArg(4) String arg4, @OriginalArg(5) int arg5) {
		try {
			if (arg4 != null) {
				arg3 -= this.method467(arg4, true) / 2;
				@Pc(18) int local18 = arg5 - this.anInt751;
				@Pc(23) int local23;
				if (arg2 != -94) {
					for (local23 = 1; local23 > 0; local23++) {
					}
				}
				for (local23 = 0; local23 < arg4.length(); local23++) {
					@Pc(38) int local38 = anIntArray220[arg4.charAt(local23)];
					if (local38 != 94) {
						this.method473(this.aByteArrayArray3[local38], arg3 + this.anIntArray216[local38], local18 + this.anIntArray217[local38] + (int) (Math.sin((double) local23 / 2.0D + (double) arg0 / 5.0D) * 5.0D), this.anIntArray214[local38], this.anIntArray215[local38], arg1);
					}
					arg3 += this.anIntArray218[local38];
				}
			}
		} catch (@Pc(96) RuntimeException local96) {
			signlink.reporterror("85997, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + arg5 + ", " + local96.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!lb", name = "a", descriptor = "(ZLjava/lang/String;IBII)V")
	public void method470(@OriginalArg(0) boolean arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		try {
			...
			if (arg1 != null) {
				...
				for (@Pc(27) int local27 = 0; local27 < arg1.length(); local27++) {
					...
					if (arg1.charAt(local27) == '@' && local27 + 4 < arg1.length() && arg1.charAt(local27 + 4) == '@') {
						local59 = this.method472((byte) 91, arg1.substring(local27 + 1, local27 + 4));
						if (local59 != -1) {
							arg4 = local59;
						}
						local27 += 4;
						...
						if (local59 != 94) {
							if (arg0) {
								this.method473(this.aByteArrayArray3[local59], arg5 + this.anIntArray216[local59] + 1, local14 + this.anIntArray217[local59] + 1, this.anIntArray214[local59], this.anIntArray215[local59], 0);
							}
							this.method473(this.aByteArrayArray3[local59], arg5 + this.anIntArray216[local59], local14 + this.anIntArray217[local59], this.anIntArray214[local59], this.anIntArray215[local59], arg4);
						}
						arg5 += this.anIntArray218[local59];
					}
				}
				if (this.aBoolean188) {
					Static14.method461(local6, local14 + (int) ((double) this.anInt751 * 0.7D), 4, 8388608, arg5 - local6);
				}
			}
		} catch (@Pc(168) RuntimeException local168) {
			signlink.reporterror("84645, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + arg5 + ", " + local168.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!lb", name = "a", descriptor = "(ILjava/lang/String;IIZII)V")
	public void method471(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		try {
			if (arg1 != null) {
				this.aRandom1.setSeed((long) arg5);
				@Pc(17) int local17 = (this.aRandom1.nextInt() & 0x1F) + 192;
				@Pc(22) int local22 = arg0 - this.anInt751;
				if (arg2 == 21042) {
					for (@Pc(28) int local28 = 0; local28 < arg1.length(); local28++) {
						@Pc(60) int local60;
						if (arg1.charAt(local28) == '@' && local28 + 4 < arg1.length() && arg1.charAt(local28 + 4) == '@') {
							local60 = this.method472((byte) 91, arg1.substring(local28 + 1, local28 + 4));
							if (local60 != -1) {
								arg3 = local60;
							}
							local28 += 4;
							...
							if (local60 != 94) {
								if (arg4) {
									this.method475(this.anIntArray215[local60], local22 + this.anIntArray217[local60] + 1, 0, 192, this.anIntArray214[local60], this.aByteArrayArray3[local60], 4, arg6 + this.anIntArray216[local60] + 1);
								}
								this.method475(this.anIntArray215[local60], local22 + this.anIntArray217[local60], arg3, local17, this.anIntArray214[local60], this.aByteArrayArray3[local60], 4, arg6 + this.anIntArray216[local60]);
							}
							arg6 += this.anIntArray218[local60];
			...
			signlink.reporterror("4775, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + arg5 + ", " + arg6 + ", " + local162.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!lb", name = "a", descriptor = "(BLjava/lang/String;)I")
	private int method472(@OriginalArg(0) byte arg0, @OriginalArg(1) String arg1) {
		try {
			if (arg0 != 91) {
				return 0;
			...
			signlink.reporterror("93318, " + arg0 + ", " + arg1 + ", " + local116.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method473(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(5) int local5 = arg1 + arg2 * Static14.anInt738;
		@Pc(9) int local9 = Static14.anInt738 - arg3;
		@Pc(11) int local11 = 0;
		@Pc(13) int local13 = 0;
		@Pc(20) int local20;
		if (arg2 < Static14.anInt740) {
			local20 = Static14.anInt740 - arg2;
			arg4 -= local20;
			arg2 = Static14.anInt740;
			local13 += local20 * arg3;
			local5 += local20 * Static14.anInt738;
		}
		if (arg2 + arg4 >= Static14.anInt741) {
			arg4 -= arg2 + arg4 + 1 - Static14.anInt741;
		}
		if (arg1 < Static14.anInt742) {
			local20 = Static14.anInt742 - arg1;
			arg3 -= local20;
		...
		if (arg1 + arg3 >= Static14.anInt743) {
			local20 = arg1 + arg3 + 1 - Static14.anInt743;
			arg3 -= local20;
			local11 += local20;
			local9 += local20;
		}
		if (arg3 > 0 && arg4 > 0) {
			this.method474(Static14.anIntArray213, arg0, arg5, local13, local5, arg3, arg4, local9, local11);
		}
	}
	...
	private void method475(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) byte[] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		try {
			if (arg6 < 4 || arg6 > 4) {
				this.aBoolean187 = !this.aBoolean187;
			}
			@Pc(19) int local19 = arg7 + arg1 * Static14.anInt738;
			@Pc(23) int local23 = Static14.anInt738 - arg4;
			@Pc(25) int local25 = 0;
			@Pc(27) int local27 = 0;
			@Pc(34) int local34;
			if (arg1 < Static14.anInt740) {
				local34 = Static14.anInt740 - arg1;
				arg0 -= local34;
				arg1 = Static14.anInt740;
				local27 += local34 * arg4;
				local19 += local34 * Static14.anInt738;
			}
			if (arg1 + arg0 >= Static14.anInt741) {
				arg0 -= arg1 + arg0 + 1 - Static14.anInt741;
			}
			if (arg7 < Static14.anInt742) {
				local34 = Static14.anInt742 - arg7;
				arg4 -= local34;
				arg7 = Static14.anInt742;
				local27 += local34;
				local19 += local34;
				local25 += local34;
				local23 += local34;
			}
			if (arg7 + arg4 >= Static14.anInt743) {
				local34 = arg7 + arg4 + 1 - Static14.anInt743;
				arg4 -= local34;
				local25 += local34;
				local23 += local34;
			}
			if (arg4 > 0 && arg0 > 0) {
				this.method476(arg2, Static14.anIntArray213, arg4, arg3, 32727, local25, arg5, local27, local23, arg0, local19);
			}
		} catch (@Pc(141) RuntimeException local141) {
			signlink.reporterror("58229, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + arg5 + ", " + arg6 + ", " + arg7 + ", " + local141.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!lb", name = "a", descriptor = "(I[IIIII[BIIII)V")
	private void method476(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) byte[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10) {
		try {
			@Pc(19) int local19 = ((arg0 & 0xFF00FF) * arg3 & 0xFF00FF00) + ((arg0 & 0xFF00) * arg3 & 0xFF0000) >> 8;
			@Pc(23) int local23 = 256 - arg3;
			if (arg4 == 32727) {
				for (@Pc(30) int local30 = -arg9; local30 < 0; local30++) {
					for (@Pc(35) int local35 = -arg2; local35 < 0; local35++) {
						if (arg6[arg7++] == 0) {
							arg10++;
						} else {
							@Pc(46) int local46 = arg1[arg10];
							arg1[arg10++] = (((local46 & 0xFF00FF) * local23 & 0xFF00FF00) + ((local46 & 0xFF00) * local23 & 0xFF0000) >> 8) + local19;
						}
					}
					arg10 += arg8;
					arg7 += arg5;
			...
			signlink.reporterror("3897, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + arg5 + ", " + arg6 + ", " + arg7 + ", " + arg8 + ", " + arg9 + ", " + arg10 + ", " + local88.toString());
			throw new RuntimeException();
		}
	}
}
