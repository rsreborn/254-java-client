...
public final class Class21 {
	...
	public void method448(@OriginalArg(0) int arg0, @OriginalArg(1) Buffer arg1) {
		try {
			...
			signlink.reporterror("98238, " + arg0 + ", " + arg1 + ", " + local73.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!kc", name = "a", descriptor = "(II)V")
	private void method449(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			...
			signlink.reporterror("15992, " + arg0 + ", " + arg1 + ", " + local305.toString());
			throw new RuntimeException();
		}
	}
