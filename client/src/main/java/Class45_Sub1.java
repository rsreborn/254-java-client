...
public final class Class45_Sub1 extends Class45 implements Runnable {
	...
	private int anInt964 = -102;

	@OriginalMember(owner = "client!vb", name = "d", descriptor = "I")
	private int anInt965 = -62;

	@OriginalMember(owner = "client!vb", name = "e", descriptor = "I")
	private int anInt966 = 810;
	...
	public int method650(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		try {
			if (arg1 != -1) {
			...
			signlink.reporterror("62159, " + arg0 + ", " + arg1 + ", " + local17.toString());
	...
	public int method651(@OriginalArg(0) boolean arg0) {
		try {
			return arg0 ? 4 : this.anIntArray262.length;
		} catch (@Pc(8) RuntimeException local8) {
			signlink.reporterror("83911, " + arg0 + ", " + local8.toString());
			throw new RuntimeException();
		}
	}
	...
	public void method653(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		try {
			@Pc(3) int local3 = this.anIntArray258.length;
			for (@Pc(5) int local5 = 0; local5 < local3; local5++) {
				if (arg1 || this.anIntArray261[local5] != 0) {
					this.method660(810, 3, (byte) 2, this.anIntArray260[local5]);
					this.method660(810, 3, (byte) 2, this.anIntArray259[local5]);
				}
			}
			if (arg0 != 41461) {
				this.aBoolean235 = !this.aBoolean235;
			...
			signlink.reporterror("70552, " + arg0 + ", " + arg1 + ", " + local49.toString());
			throw new RuntimeException();
		}
	}
	...
	public int method655(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1) {
		try {
			if (arg0 != 5) {
				this.anInt965 = -465;
			}
			return this.aByteArray17[arg1] & 0xFF;
		} catch (@Pc(13) RuntimeException local13) {
			signlink.reporterror("24972, " + arg0 + ", " + arg1 + ", " + local13.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!vb", name = "b", descriptor = "(IZ)Z")
	public boolean method656(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		try {
			if (arg1) {
			...
			signlink.reporterror("95152, " + arg0 + ", " + arg1 + ", " + local16.toString());
			throw new RuntimeException();
		}
	}
	...
	public void method657(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 < 0 || arg0 > this.anIntArrayArray23.length || arg1 < 0 || arg1 > this.anIntArrayArray23[arg0].length || this.anIntArrayArray23[arg0][arg1] == 0) {
			return;
		}
		@Pc(27) Class34 local27 = this.aClass34_2;
		synchronized (this.aClass34_2) {
			@Pc(34) Class1_Sub1_Sub4 local34;
			for (local34 = (Class1_Sub1_Sub4) this.aClass34_2.method533(); local34 != null; local34 = (Class1_Sub1_Sub4) this.aClass34_2.method534(6)) {
	...
	public void method660(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2, @OriginalArg(3) int arg3) {
		try {
			if (this.aClient2.aClass46Array1[0] != null && this.anIntArrayArray23[arg1][arg3] != 0) {
				@Pc(25) byte[] local25 = this.aClient2.aClass46Array1[arg1 + 1].method670(9, arg3);
				if (arg0 <= 0) {
					this.anInt966 = 195;
				}
				if (!this.method667(local25, this.anIntArrayArray23[arg1][arg3], false, this.anIntArrayArray24[arg1][arg3])) {
			...
			signlink.reporterror("67853, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local70.toString());
			throw new RuntimeException();
		}
	}
	...
	public void method661(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("59253, " + arg0 + ", " + local24.toString());
			throw new RuntimeException();
		}
	}
	...
	public void method662(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			if (this.aClient2.aClass46Array1[0] != null && (this.anIntArrayArray23[arg0][arg1] != 0 && (this.aByteArrayArray5[arg0][arg1] != 0 && this.anInt967 != 0))) {
			...
			signlink.reporterror("58476, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + local65.toString());
			throw new RuntimeException();
		}
	}
	...
	public void run() {
		try {
			while (this.aBoolean236) {
				...
				if (this.anInt967 == 0 && this.aClient2.aClass46Array1[0] != null) {
					local11 = 50;
				}
				try {
				...
				for (@Pc(32) int local32 = 0; local32 < 100 && this.aBoolean237; local32++) {
					...
					this.method665(this.aBoolean235);
				...
				for (local73 = (Class1_Sub1_Sub4) this.aClass31_10.method523(); local73 != null; local73 = (Class1_Sub1_Sub4) this.aClass31_10.method525(6)) {
					if (local73.aBoolean205) {
						local68 = true;
						local73.anInt807++;
						if (local73.anInt807 > 50) {
							local73.anInt807 = 0;
							this.method668(local73, 6);
						}
					}
				}
				if (!local68) {
				...
				if (this.aClient2.aBoolean46 && this.aSocket2 != null && this.anOutputStream2 != null && (this.anInt967 > 0 || this.aClient2.aClass46Array1[0] == null)) {
					this.anInt975++;
	...
	private void method663(@OriginalArg(0) int arg0) {
		try {
			if (arg0 == 2) {
				...
				while (local13 != null) {
					...
					if (this.aClient2.aClass46Array1[0] != null) {
						local24 = this.aClient2.aClass46Array1[local13.anInt805 + 1].method670(9, local13.anInt806);
					}
					if (!this.method667(local24, this.anIntArrayArray23[local13.anInt805][local13.anInt806], false, this.anIntArrayArray24[local13.anInt805][local13.anInt806])) {
						local24 = null;
					}
			...
			signlink.reporterror("71318, " + arg0 + ", " + local112.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method664(@OriginalArg(0) int arg0) {
		try {
			...
			for (local21 = (Class1_Sub1_Sub4) this.aClass31_10.method523(); local21 != null; local21 = (Class1_Sub1_Sub4) this.aClass31_10.method525(6)) {
			...
			while (this.anInt968 < 10) {
				...
				this.anInt968++;
				this.method668(local21, 6);
				this.aBoolean237 = true;
			}
		} catch (@Pc(104) RuntimeException local104) {
			signlink.reporterror("85337, " + arg0 + ", " + local104.toString());
			throw new RuntimeException();
		}
	}
				...
				while (this.anInt968 == 0) {
					...
					for (@Pc(111) int local111 = 0; local111 < 4; local111++) {
						...
						for (@Pc(123) int local123 = 0; local123 < local121; local123++) {
							if (local118[local123] == this.anInt967) {
								local118[local123] = 0;
		...
		try {
			...
			try {
				...
				if (this.anInt973 == 0 && local10 >= 6) {
					...
					for (@Pc(92) Class1_Sub1_Sub4 local92 = (Class1_Sub1_Sub4) this.aClass31_10.method523(); local92 != null; local92 = (Class1_Sub1_Sub4) this.aClass31_10.method525(6)) {
					...
					this.anInt972 = local84 * 500;
					this.anInt973 = 500;
					if (this.anInt973 > local77 - local84 * 500) {
						this.anInt973 = local77 - local84 * 500;
					}
				}
				if (this.anInt973 > 0 && local10 >= this.anInt973) {
					this.aBoolean237 = true;
					@Pc(229) byte[] local229 = this.aByteArray18;
					local45 = 0;
					if (this.aClass1_Sub1_Sub4_1 != null) {
						local229 = this.aClass1_Sub1_Sub4_1.aByteArray10;
						local45 = this.anInt972;
					}
					for (local61 = 0; local61 < this.anInt973; local61 += this.anInputStream2.read(local229, local61 + local45, this.anInt973 - local61)) {
					}
					if (this.anInt973 + this.anInt972 >= local229.length && this.aClass1_Sub1_Sub4_1 != null) {
						if (this.aClient2.aClass46Array1[0] != null) {
							this.aClient2.aClass46Array1[this.aClass1_Sub1_Sub4_1.anInt805 + 1].method671(local229.length, this.aClass1_Sub1_Sub4_1.anInt806, local229, this.aBoolean233);
						}
			...
			signlink.reporterror("11999, " + arg0 + ", " + local363.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!vb", name = "a", descriptor = "([BIZI)Z")
	private boolean method667(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3) {
		try {
			...
			signlink.reporterror("51310, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local65.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lclient!nb;I)V")
	private void method668(@OriginalArg(0) Class1_Sub1_Sub4 arg0, @OriginalArg(1) int arg1) {
		try {
			if (arg1 == 6) {
				try {
					if (this.aSocket2 == null) {
						...
						this.aSocket2 = this.aClient2.method111(Static6.anInt262 + 43594);
			...
			signlink.reporterror("237, " + arg0 + ", " + arg1 + ", " + local138.toString());
			throw new RuntimeException();
		}
	}
}
